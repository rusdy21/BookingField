        ...
        <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Booking</h6>
                </div>
                <div class="card-body">
                    <div class="col-lg-12">
                        <form action="{{route('booking.store')}}" class="user" method="post">
                            @csrf
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    <select name="field" id="field" class="form-control">
                                        ...
                                        @foreach ($field as $item)
                                            <option value="{{ $item->id_field}}">{{ $item->nama_field}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    @enderror" id="BookingDate" name="BookingDate">
                                </div>
                                @error('BookingDate')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    <select class="form-control" name="time_start" id="time_start"></select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    <select class="form-control" name="time_finish" id="time_finish"></select>
                                </div>
                            </div>
                            <div class="form-group row">
